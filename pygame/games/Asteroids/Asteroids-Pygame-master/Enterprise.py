...
#Missile sound
missile_sound = pygame.mixer.Sound(os.path.join('sounds','missile.wav'))
missile_sound.set_volume(1)

#thrust sound
thruster_sound = pygame.mixer.Sound(os.path.join('sounds','thrust.wav'))
...
#background score
pygame.mixer.music.load(os.path.join('sounds','trektheme.wav'))
